...
<a href="./Execution_code_TTE_COVID-19_BCG_only.mod">Download here</a>

```
$PROBLEM    Time-to-event analysis of PCR-confirmed COVID-19 data, ITT dataset
...
$DATA      COVID19_TTE_ITT_20211203.csv IGNORE=@
;Sim_start
IGNORE=(TYPE.EQ.3)
;IGNORE=(TYPE.EQ.2)
